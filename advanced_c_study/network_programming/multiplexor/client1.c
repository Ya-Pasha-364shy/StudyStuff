...
int continue_semaphore_client1(int param) {
...
int main() {
    ...
    for (i = 1; i <= 5; i++) {
        ...
        mybuf.mtype = 1;
        mybuf.id_client1 = 5;
        strcpy(mybuf.mtext, "This is text MESSAGE from client1");
    ...
    int res = continue_semaphore_client1(0);
    ...
    int res2 = continue_semaphore_client1(1);
